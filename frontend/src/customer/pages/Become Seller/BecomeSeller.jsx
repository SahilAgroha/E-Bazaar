    ...
    <div className='grid md:gap-10 grid-cols-3 min-h-screen'>
        ...
        <section className=" md:col-span-1 lg:col-span-2 md:flex justify-center items-center">
            <div className="lg:w-[70%] px-5 space-y-10">
                ...
                <img src='https://imgs.search.brave.com/xbP4QWE8gnp-vwMw9bhpZ4V84T29fNx9i2XfwlkSuI0/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9zdGF0/aWMudmVjdGVlenku/Y29tL3N5c3RlbS9y/ZXNvdXJjZXMvdGh1/bWJuYWlscy8wMDcv/MTg1LzU5MC9zbWFs/bC9ibXctbTQtY2Fy/LTNkLXJlbmRlci1p/bWFnZS1mcmVlLXBo/b3RvLmpwZw'/>
            </div>
        </section>
