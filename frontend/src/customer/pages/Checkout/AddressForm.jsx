...
const AddressFormSchema = Yup.object().shape({
    ...
    mobile: Yup.string().required('Mobile number is required').matches(/^[6-9]\d{9}$/, 'Mobile number must be 10 digits'),
    pinCode: Yup.string().required('Pin code is required').matches(/^[1-9][0-9]{5}$/, 'Pin code must be 6 digits'),
